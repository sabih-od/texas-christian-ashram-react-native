...
const AnnouncementBox = ({ item, navigation }) => {
    return (
        <TouchableOpacity style={styles.datetime} activeOpacity={0.8}
...
const styles = StyleSheet.create({
    ...
    eventtitlerow: { padding: 10, backgroundColor: colors.white, width: '100%', minHeight: 130 },
    eventtitle: { fontFamily: fonts.headingFont, color: colors.black, fontSize: 17, marginBottom: 3 },
