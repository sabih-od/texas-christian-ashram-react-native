...
const SermonsBox = ({ item, width, navigation }) => {
    ...
    return (<TouchableOpacity
        ...
        style={{ width: width ? width : '48%', marginBottom: 12 }}>
        <ImageBackground
...
const styles = StyleSheet.create({
    postboxtitle: { fontFamily: fonts.headingFont, color: colors.black, fontSize: 16, textTransform: 'capitalize' },
    sermonbgimage: { width: '100%', height: 130, borderRadius: 8, overflow: 'hidden', alignItems: 'center', justifyContent: 'center', marginBottom: 4 },
